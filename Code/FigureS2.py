...
def plot_11ms_categories_timeseries(years, V0, d, filename):
    ...
    plt.xlabel('Year')
    plt.ylabel('Time to Vmax=11m/s (h)')
    plt.legend(loc='upper left')  
...
def main():
    ...
    plot_timescale_with_regression(year_all, t_11ms_all, 
                                   'Annual Time to Decay to 11m/s', 
                                   'Time (h)', 
                                   './FigureS2b.png')
    

    
    plot_11ms_categories_timeseries(year_all, V0_all, t_11ms_all,
                                       './FigureS2a.png')
